...
|:------------------:|:-----------------:|:------------------------:|:----------------:|
| Grand Prize + Logitech Kit | Premium Goodies | Swag Pack | Certificates + Internship Opps |
...
| 🕐 Time | Code | Pit Stop | Status |
|:-------:|:----:|:--------:|:-------|
| **8:30 AM** | `0x0A` | 🔴 CHECK-IN | Reporting — scrutineering & paddock entry |
| **9:00 AM** | `0x1A` | 📋 OFFICIALS | Registrations open — driver livery collection |
| **10:30 AM** | `0x2A` | 🟡 FORMATION LAP | Opening Ceremony — system diagnostics complete |
| **12:00 PM** | `0x3A` | 🟢 **RACE START** | **Green flag! 24-hour clock begins. ERS enabled.** |
| **5:00 PM** | `0x4A` | ☕ REFRESH | High Tea — fuel & tire management |
| **7:00 PM** | `0x5A` | 🛠️ PIT STOP I | Mentorship Round I — mid-race strategy tuning |
| **8:00 PM** | `0x6A` | 🍽️ DINNER | Evening fuel stop |
...
| 🕐 Time | Code | Pit Stop | Status |
|:-------:|:----:|:--------:|:-------|
| **8:30 AM** | `0x7A` | 🌅 BREAKFAST | Morning boost — fresh tires, new strategy |
| **9:00 AM** | `0x8A` | 🏎️ FINAL STINT | Mentorship Round II — push for fastest lap |
| **12:00 PM** | `0x9A` | 🏁 **RACE END** | **Chequered flag — submissions closed. Cool down lap.** |
| **12:15 PM** | `0x10A` | 🥗 LUNCH | Post-race recovery mode |
| **1:00 PM** | `0x11A` | ⚖️ JUDGING | Technical inspection — stewards review begins |
| **4:00 PM** | `0x12A` | 🏆 **PODIUM** | **Results & Closing Ceremony — Victory lap!** |
